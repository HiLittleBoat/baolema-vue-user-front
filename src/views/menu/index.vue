<template>
  <div>
    ...
    <title>菩提阁</title>
    <link rel="icon" href="../../assets/front/images/favico.ico">
    <div id="main" class="app">
      <div class="divHead">
        <img src="../../assets/front/images/user.png" @click="toUserPage"/>
      </div>
      <div class="divTitle">
        <div class="divStatic">
          <img src="../../assets/front/images/logo.png"  class="logo"/>
          <div class="divDesc">
            <div class="divName">菩提阁餐厅</div>
            <div class="divSend">
              <span><img src="../../assets/front/images/time.png"/> 距离1.5km</span>
              <span><img src="../../assets/front/images/money.png"/> 配送费6元</span>
              <span><img src="../../assets/front/images/location.png"/> 预计时长12min</span>
            </div>
          </div>
        </div>
        <div class="divDesc">
            ...
            <div class="divItem" v-for="(item,index) in dishList" :key="index" @click="dishDetails(item)">
              <el-image :src="imgPathConvert(item.image)" >
                <div slot="error" class="image-slot">
                  <img src="../../assets/front/images/noImg.png"/>
                </div>
              </el-image>
              <div>
                ...
                <div class="divNum">
                  <div class="divSubtract" v-if="item.number > 0">
                    <img src="../../assets/front/images/subtract.png" @click.prevent.stop="subtractCart(item)"/>
                  </div>
                  ...
                  <div class="divAdd" v-else>
                    <img src="../../assets/front/images/add.png" @click.prevent.stop="addCart(item)"/>
                  </div>
                </div>
              </div>
            </div>
      ...
      <van-dialog v-model="dialogFlavor.show" :show-confirm-button="false" class="dialogFlavor" ref="flavorDialog">
        ...
        <div class="divFlavorClose" @click="dialogFlavor.show = false">
          <img src="../../assets/front/images/close.png"/>
        </div>
      </van-dialog>
          ...
          <div v-for="item in cartData" :key="item.id" class="divCartItem">
            ...
            <div class="divNum">
              <div class="divSubtract">
                <img src="../../assets/front/images/subtract.png" @click="cartNumberSubtract(item)"/>
              </div>
              <div class="divDishNum">{{item.number}}</div>
              <div class="divAdd">
                <img src="../../assets/front/images/add.png" @click="cartNumAdd(item)"/>
              </div>
            </div>
        ...
        <div class="divNum">
          ...
          <div class="right">
            <div class="divSubtract" v-if="detailsDialog.item.number > 0">
              <img src="../../assets/front/images/subtract.png" @click="subtractCart(detailsDialog.item)"/>
            </div>
            ...
            <div class="divAdd" v-else>
              <img src="../../assets/front/images/add.png" @click="addCart(detailsDialog.item)"/>
            </div>
          </div>
        </div>
        ...
        <div class="divNum">
          ...
          <div class="right">
            <div class="divSubtract" v-if="setMealDialog.item.number > 0">
              <img src="../../assets/front/images/subtract.png" @click="subtractCart(setMealDialog.item)"/>
            </div>
            <div class="divDishNum">{{setMealDialog.item.number}}</div>
            <div class="divAdd" v-if="setMealDialog.item.number">
              <img src="../../assets/front/images/add.png" @click="addCart(setMealDialog.item)"/>
            </div>
...
<script>
  //<!--不同屏幕尺寸根字体设置-->
  import "../../assets/front/js/base.js";
  //<!-- 开发环境版本，包含了有帮助的命令行警告 -->
  import "../../assets/backend/plugins/vue/vue.js";
  //<!-- 引入组件库 -->
  import "../../assets/backend/plugins/element-ui/index.js";
  //<!-- 引入vant样式 -->
  import "../../assets/front/js/vant.min.js";
  //<!-- 引入axios -->
  import "../../assets/backend/plugins/axios/axios.min.js";
  import "../../assets/front/js/request.js";
  import "../../assets/front/js/common.js";
  import "../../assets/front/api/main.js";
  export default {
    name: 'index',
    data:function (){
      return {
      ...
      toAddOrderPage(){
        if(this.cartData.length > 0){
          window.requestAnimationFrame(()=>{
            window.location.href ='/front/add_order'
          })
        }
      },
      toUserPage(){
...
<style>
@import "../../assets/backend/plugins/element-ui/index.css";
@import "../../assets/front/styles/vant.min.css";
@import "../../assets/front/styles/index.css";
@import "../../assets/front/styles/main.css";
</style>
